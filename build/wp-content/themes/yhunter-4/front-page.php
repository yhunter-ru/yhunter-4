...
<div class="intro">
    ...
    <div class="intro__contacts contacts">
        ...
        <div class="contacts__social">
            ...
            <a href="https://www.instagram.com/_yhunter_/" class="contacts__icon ig"><span>instagram</span></a>
    ...
    <div class="intro__portfolio portfolio">
        <div class="portfolio__header">
            Работ в <a href="">Портфолио</a>
            <a href="" title="Другие работы" class="portfolio__counter">137</a>
        </div>
        <div class="portfolio__tiles window tiles">
            <div class="tiles__container">
                <div class="tiles__wrapper">
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2020/06/bear-cover.jpg"
                            alt=""></div>
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2019/10/pcbk.jpg"
                            alt=""></div>
                    <div class="tiles__item"><img
                            src="https://www.yhunter.ru/wp-content/uploads/2019/10/404667_original.jpg" alt=""></div>
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2019/10/may-logo.jpg"
                            alt=""></div>
                    <div class="tiles__item"><img
                            src="https://www.yhunter.ru/wp-content/uploads/2019/10/pzs-thumb-300x300.jpg" alt=""></div>
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2018/06/kompros.jpg"
                            alt=""></div>
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2018/06/mobius-web.jpg"
                            alt=""></div>
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2018/06/datanomics.jpg"
                            alt=""></div>
                    <div class="tiles__item"><img src="https://www.yhunter.ru/wp-content/uploads/2018/06/senator.png"
                            alt=""></div>
                </div>
            </div>
        </div>
...
<div class="about">
    ...
    <div class="about__main">
        <p><i>Меня зовут</i> <b>Юрий Баранов</b>. <i>Я живу и</i> <b>делаю сайты в Перми</b></p>
    </div>
    <div class="about__big">
        <h2>
            <span><a href="">Создание сайтов</a>, <a href="">дизайн</a>,</span><span><a href="">фронтэнд
                    разработка</a></span>
        </h2>
    </div>
    ...
    <div class="about__portfolio">
        <p>За это время
            <nobr>в <a href="">портфолио</a></nobr> скопилось:</p>
    </div>
    ...
    <div class="about__add add">
        ...
        <ul class="add__items">
            <li>Легкая самообучаемость любых технологий, в зависимости от поставленной задачи;</li>
            <li>Опыт проведения технических собеседований для разработчиков.</li>
        </ul>
    </div>
    ...
    <div class="about__text text">
        ...
        популяризации моддинга, увлечен аэрографией, был замечен в концертно-организацонной деятельности. Передвигаюсь
        по городу на автомобиле и велосипеде.
    </div>

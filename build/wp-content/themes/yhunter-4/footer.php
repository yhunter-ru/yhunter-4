		...
		<div class="r w">
			...
			<div class="xs12 md10 lg5">
				...
				<div class="footer__cloud">
					...
					<a href="https://www.yhunter.ru/tag/frontend/"
						class="tag-cloud-link tag-link-72 tag-link-position-4" style="font-size: 20.141592920354pt;"
						aria-label="frontend (67 элементов)">frontend</a>
					...
					<a href="https://www.yhunter.ru/tag/wordpress/"
						class="tag-cloud-link tag-link-81 tag-link-position-8" style="font-size: 18.778761061947pt;"
						aria-label="wordpress (51 элемент)">wordpress</a>
					...
					<a href="https://www.yhunter.ru/tag/adaptive/"
						class="tag-cloud-link tag-link-104 tag-link-position-14" style="font-size: 14.070796460177pt;"
						aria-label="адаптивная верстка (21 элемент)">адаптивная верстка</a>
					...
					<a href="https://www.yhunter.ru/tag/veb-dizajn/"
						class="tag-cloud-link tag-link-71 tag-link-position-16" style="font-size: 20.513274336283pt;"
						aria-label="веб-дизайн (71 элемент)">веб-дизайн</a>
					...
					<a href="https://www.yhunter.ru/tag/logotipy/"
						class="tag-cloud-link tag-link-88 tag-link-position-22" style="font-size: 9.858407079646pt;"
						aria-label="логотипы (9 элементов)">логотипы</a>
					...
					<a href="https://www.yhunter.ru/tag/texdizajn/"
						class="tag-cloud-link tag-link-86 tag-link-position-28" style="font-size: 8pt;"
						aria-label="техдизайн (6 элементов)">техдизайн</a>
			...
			<div class="xs12 md12 lg3 contact">
				...
				<ul>
					...
					<li><a href="tg://resolve?domain=yhunter" class="tg">@yhunter</a></li>
				</ul>
			</div>
			<div class="xs12 md12 footer__copy">
				© Юрий Баранов, 2004—2022. v4.0 β
			</div>
		</div>
	</div>
...
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/main.min.css?rev=0.34547660626120424">

<script src="<?php echo get_template_directory_uri(); ?>/js/vendor/jquery.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/main.js?rev=0.34547660626120424"></script>
<?php
/**
